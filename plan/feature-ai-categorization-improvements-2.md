...
1. **Few-shot examples from approved history** — include the user's own approved/applied suggestions as in-prompt examples so the model sees how *this user* categorizes transactions.
